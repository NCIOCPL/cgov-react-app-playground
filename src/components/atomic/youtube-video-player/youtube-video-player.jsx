...
const YoutubeVideoPlayer = ({ youtubeId, videoTitle, trackVideoLoad = () => {} }) => {
	...
	const renderPlaceholder = () => {
		return swapped ? (
			...
			<button data-testid="button.video-preview--container" className="video-preview--container" onClick={loadVideo} tabIndex="0">
	...
	return (
		<div data-testid=".youtube-video-player" className="youtube-video-player flex-video widescreen rendered">
			{renderPlaceholder()}
		</div>
	);
};
