...
module.exports = function (webpackEnv) {
	...
	const getStyleLoaders = (cssOptions, preProcessor) => {
		...
		if (preProcessor) {
				...
				// The following packages are used to build the NCI Design System (NCIDS) css
				// from the included NCI scss files & the U.S. Web Design System (USWDS) scss files.
				// The NCIDS adds in special token palletes and overrides into the USWDS
				// to fit the NCI brand design
			const processorOpts =
